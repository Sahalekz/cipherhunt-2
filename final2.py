...
QUESTIONS: List[Dict] = [
    {
        "question": "🔍 Level 1\n\nI have seen every late comer’s best acting performance .(4 letters)",
    ...
    {
        "question": "🔍 Level 2\n\nI’m used for questions more than people .(9 letters)",
    ...
    {
        "question": "🔍 Level 4\n\nA spot for clean start .(2 words)",
    ...
    {
        "question": "🔍 Level 5\n\nI roar when silence falls .(2 words)",
